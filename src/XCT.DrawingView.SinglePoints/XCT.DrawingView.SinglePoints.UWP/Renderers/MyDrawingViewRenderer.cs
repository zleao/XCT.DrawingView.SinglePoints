...
using XCT.DrawingView.SinglePoints.Controls;
using XCT.DrawingView.SinglePoints.UWP.Renderers;
using Size = Windows.Foundation.Size;

[assembly: ExportRenderer(typeof(MyDrawingView), typeof(MyDrawingViewRenderer))]
namespace XCT.DrawingView.SinglePoints.UWP.Renderers
{

    /// <summary>
    /// UWP renderer for <see cref="Xamarin.CommunityToolkit.UI.Views.DrawingViewRenderer"/>
    /// </summary>
    public class MyDrawingViewRenderer : ViewRenderer<Xamarin.CommunityToolkit.UI.Views.DrawingView, InkCanvas>
    {
        InkCanvas canvas;
        bool disposed;
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Xamarin.CommunityToolkit.UI.Views.DrawingView.LinesProperty.PropertyName && canvas != null)
            {
                canvas.InkPresenter.StrokesCollected -= OnInkPresenterStrokesCollected;
        ...
        void LoadLines()
        {
            ...
            foreach (var line in lines)
            {
                ...
                //FIX2: If a line has just one point, add another point with the same coordinates to fix bug in UWP
